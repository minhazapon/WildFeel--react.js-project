...
const SignUp = () => {
    ...
    return (
        ...
        <div className=" flex justify-center">
         ...
         <div className=" animate__animated   animate__flip animate__repeat-2 w-full max-w-md p-8 space-y-3 rounded-xl  bg-gradient-to-r from-black to-[#02CCFF] text-gray-100">
